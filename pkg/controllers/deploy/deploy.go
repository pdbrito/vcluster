...
func (r *Deployer) checkIfUpgradeNeeded(cm *corev1.ConfigMap, chart config2.ExperimentalDeployHelm) (bool, error) {
...
func (r *Deployer) initiateUpgrade(ctx context.Context, chart config2.ExperimentalDeployHelm) error {
	name, namespace := r.getTargetRelease(chart)
...
func (r *Deployer) findChart(chart config2.ExperimentalDeployHelm) (string, error) {
...
func (r *Deployer) initiateInstall(ctx context.Context, chart config2.ExperimentalDeployHelm) error {
	// initiate install
	name, namespace := r.getTargetRelease(chart)
	path, err := r.findChart(chart)
	if err != nil {
...
func (r *Deployer) getHashedConfig(chart config2.ExperimentalDeployHelm) (string, error) {
...
func (r *Deployer) releaseExists(chart config2.ExperimentalDeployHelm) (bool, error) {
	name, namespace := r.getTargetRelease(chart)
...
func (r *Deployer) pullChartArchive(ctx context.Context, chart config2.ExperimentalDeployHelm) error {
...
func (r *Deployer) parseTimeout(chart config2.ExperimentalDeployHelm) time.Duration {
	t := chart.Timeout
...
func (r *Deployer) getTargetRelease(chart config2.ExperimentalDeployHelm) (string, string) {
...
func (r *Deployer) setChartStatusLastApplied(cm *corev1.ConfigMap, chart *config2.ExperimentalDeployHelm) error {
	status := ParseStatus(cm)
...
func (r *Deployer) setChartStatus(cm *corev1.ConfigMap, chart *config2.ExperimentalDeployHelm, phase InitObjectStatus, reason string, message string) error {
	status := ParseStatus(cm)
...
func (r *Deployer) deleteHelmRelease(cm *corev1.ConfigMap, chartStatus ChartStatus) error {
	...
	if err != nil {
		...
		return r.setChartStatus(cm, &config2.ExperimentalDeployHelm{
			Chart: config2.ExperimentalDeployHelmChart{
				Name: chartStatus.Name,
			},
			Release: config2.ExperimentalDeployHelmRelease{
